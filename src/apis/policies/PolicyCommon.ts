...
import { GET_ALL_POLICIES_URL, GET_POLICY_URL } from "./PolicyUrl";
...
export const getPolicies = async (
    ...
    try {
        ...
        PageResponseDto<PolicyListResponseDto>>> = await axiosInstance.get(GET_ALL_POLICIES_URL,{
...
export const getPolicyDetail = async(
    ...
    try{
        ...
        return responseErrorHandler(error as AxiosError<ResponseDto<
        PageResponseDto<PolicyDetailResponseDto>>>);
    }
}
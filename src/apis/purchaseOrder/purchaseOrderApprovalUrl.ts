...
export const PURCHASE_APPROVAL_MODULE_URL_ADMIN = `${ADMIN_URL}/purchase-order-approval`;
...
export const PURCHASE_APPROVAL_LOGS_URL = `${ADMIN_URL}/purchase-order-approvals`;
